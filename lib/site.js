export const site = {
  ...
  reviewCount: 53,
  ratingValue: '5.0',
  // Short link supplied by the client. Resolves to the profile with the reviews
  // tab open (!18m1!1e1). The maps/place/?q=place_id: format returned 200 but
  // did not land on the business, which is why the review buttons went nowhere.
  gbpUrl: 'https://maps.app.goo.gl/yE3jXXviZGWYMm2w7',
  // CID based fallback, durable and independent of the short link service
  mapsUrl: 'https://www.google.com/maps?cid=1473056420950100145',
